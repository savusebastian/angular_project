...
def smart_products_DB():
	...
	URL = 'https://www.smart-products.ro/accesorii-dslr/lumini-dslr/blit-universal-speedlite-camere-dslr-patina-universala'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'price':
					data[item] = split_data[i + 1].strip()[2:-1]
