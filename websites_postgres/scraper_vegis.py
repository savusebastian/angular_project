...
def vegis_DB():
	...
	URL = 'https://www.vegis.ro/sitemap.xml'
	...
	for link in links[419:]:
		try:
			...
			for item in schemaorg_data:
				...
				if item.get('itemprop') == 'priceCurrency' or item.get('itemprop') == 'price' or item.get('itemprop') == 'sku' or item.get('itemprop') == 'productID' or item.get('itemprop') == 'brand':
