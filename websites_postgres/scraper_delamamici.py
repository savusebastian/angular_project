...
def delamamici_DB():
	...
	URL = 'https://www.delamamici.ro/produs/mini-maimutica-pentru-dintisori-tratata-antibacterian'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'image' or item == 'brand' or item == 'priceCurrency' or item == 'price':
					data[item] = split_data[i + 2]
