...
def watchzone_DB():
	...
	URL = 'https://www.watchzone.ro/home/1529-curea-ceas-neagra-cusatura-alba-handmade-piele-naturala-18mm.html'
	...
	for link in links:
		try:
			...
			for item in schemaorg_data:
				if item.get('itemprop') == 'name' and exists_name == False and item.get('content') == None:
