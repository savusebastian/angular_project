...
def steaua_divina_DB():
	...
	collection = db['steaua_divina_products']

	URL = 'https://www.steauadivina.ro/sitemap_products.xml'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'image' or item == 'mpn' or item == 'sku'or item == 'priceCurrency' or item == 'price':
					data[item] = split_data[i + 2]
