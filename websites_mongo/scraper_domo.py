...
def domo_DB():
	...
	collection = db['domo_products']

	URL = 'https://www.domo.ro/laptop-laptopuri/laptop-gaming-asus-tuf-fx505du-amd-ryzen-7-3750h-512gb-ssd-16gb-nvidia-geforce-gtx-1660-ti-6gb-fullhd-tastatura-iluminata-negru-pMCU1MTAvMg-l'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'model' or item == 'mpn' or item == 'sku' or item == 'productID' or item == 'priceCurrency' or item == 'availability' or item == 'brand':
					data[item] = split_data[i + 2]

				if item == 'price':
					data[item] = split_data[i + 1][1:]
