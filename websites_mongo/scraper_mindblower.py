...
def mindblower_DB():
	...
	collection = db['mindblower_products']

	URL = 'https://mindblower.ro/sitemap/sitemap_products.xml'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'image' or item == 'mpn' or item == 'sku' or item == 'productID' or item == 'priceCurrency' or item == 'price':
					data[item] = split_data[i + 2]
