...
def automobilus_DB():
	...
	collection = db['automobilus_products']

	URL = 'https://www.automobilus.ro/filtru-combustibil-herth-buss-jakoparts-j1332021.html'
	...
	for link in links:
		try:
			...
			schemaorg_data = web_soup.find_all(type='application/ld+json')[3].get_text()
			...
			for item in split_data:
				...
				if item == 'image' or item == 'sku' or item == 'priceCurrency' or item == 'price' or item == 'availability':
					data[item] = split_data[i + 2]
