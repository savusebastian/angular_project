...
def giftforyou_DB():
	...
	collection = db['giftforyou_products']

	URL = 'https://www.giftforyou.ro/sitemap/sitemap_products.xml'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'image' or item == 'model' or item == 'priceCurrency' or item == 'price':
					data[item] = split_data[i + 2]
