...
def iconicul_DB():
	...
	collection = db['iconicul_products']

	URL = 'https://www.iconicul.ro/tunica-dama-albastra-cu-buzunare-si-paiete'
	...
	for link in links:
		try:
			...
			schemaorg_data = web_soup.find_all(type='application/ld+json')[3].contents[0]
			...
			for item in split_data:
				...
				if item == 'sku' or item == 'mpn' or item == 'model' or item == 'priceCurrency' or item == 'price' or item == 'image':
					data[item] = split_data[i + 2]
