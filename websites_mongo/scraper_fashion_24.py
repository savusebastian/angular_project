...
def fashion_24_DB():
	...
	collection = db['fashion_24_products']

	URL = 'https://www.fashion-24.ro/rochii-de-toamna/rochie-melisa-negru-si-alb-accesorizata'
		...
		try:
			...
			for item in schemaorg_data:
				...
				if item.get('itemprop') == 'price':
					data[item.get('itemprop')] = item.get_text()[:-4]
