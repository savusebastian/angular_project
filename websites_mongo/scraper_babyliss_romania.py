...
def babyliss_romania_DB():
	cluster = MongoClient('mongodb://localhost:27017/vrem_reduceri_db')
	db = cluster['vrem_reduceri_db']
	collection = db['babyliss_romania_products']

	URL = 'https://www.babyliss-romania.ro/index/sitemap-products.xml?v=014175babyliss'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'sku' or item == 'mpn' or item == 'priceCurrency' or item == 'price' or item == 'image':
					data[item] = split_data[i + 2]
