...
def autoeco_DB():
	...
	collection = db['autoeco_products']

	URL = 'https://www.autoeco.ro/set-ambreiaj-sachs-2290-601-009/a11134887'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'image' or item == 'mpn' or item == 'priceCurrency' or item == 'price':
					data[item] = split_data[i + 2]
