...
def emag_DB():
	...
	collection = db['emag_products']

	URL = 'https://www.emag.ro/sitemaps/offers-available-index.xml'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'image' or item == 'mpn' or item == 'sku' or item == 'price' or item == 'priceCurrency':
					data[item] = split_data[i + 2]
