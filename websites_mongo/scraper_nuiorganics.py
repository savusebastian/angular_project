...
def nuiorganics_DB():
	...
	collection = db['nuiorganics_products']

	URL = 'https://www.nuiorganics.ro/bluza-hopu-top-carbune'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'mpn' or item == 'priceCurrency' or item == 'price' or item == 'image':
					data[item] = split_data[i + 2]
