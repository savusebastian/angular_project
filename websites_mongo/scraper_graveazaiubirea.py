...
def graveazaiubirea_DB():
	...
	collection = db['graveazaiubirea_products']

	all_links = [
		'https://www.graveazaiubirea.ro/sitemap_cat_149.xml',
		'https://www.graveazaiubirea.ro/sitemap_cat_150.xml',
		'https://www.graveazaiubirea.ro/sitemap_cat_151.xml',
		'https://www.graveazaiubirea.ro/sitemap_cat_161.xml',
		'https://www.graveazaiubirea.ro/sitemap_cat_153.xml',
	]
