...
def crockpot_romania_DB():
	cluster = MongoClient('mongodb://localhost:27017/vrem_reduceri_db')
	db = cluster['vrem_reduceri_db']
	collection = db['crockpot_romania_products']

	URL = 'https://www.crockpot-romania.ro/index/sitemap-products.xml?v=014175crockpot'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'image' or item == 'sku' or item == 'mpn' or item == 'priceCurrency' or item == 'price':
					data[item] = split_data[i + 2]
