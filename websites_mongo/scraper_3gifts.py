...
def f3gifts_DB():
	...
	collection = db['3gifts_products']

	URL = 'https://www.3gifts.ro/cani-originale/cana-cu-note-muzicale.html'
	...
	for link in links:
		try:
			...
			for item in split_data:
				...
				if item == 'image' or item == 'sku' or item == 'mpn' or item == 'productID' or item == 'priceCurrency' or item == 'price':
					data[item] = split_data[i + 2]
